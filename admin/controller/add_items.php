            ...
            if($item_size <= 500000){
                ...
                if($check_item->rowCount() > 0){
                    ...
                    if(move_uploaded_file($_FILES['item_foto']['tmp_name'], $item_folder)){
                        $add_item = $connectdb->prepare("INSERT INTO menu (item_name, item_category, item_prize, company, item_foto, item_description, payment_option, delivery_time) VALUES (:item_name, :item_category, :item_prize, :company, :item_foto, :item_description, :payment_option, :delivery_time)");

...
<head>
    ...
    <title>ACPN Conference| Attendance</title>
...
<body>
    ...
    <header>
        <h1 class="logo">
            <a href="user_attendance.php" title="ACPN">
    ...
    <main>
        ...
        <div id="attendance" class="displays allResults">
            <h2>Attendnace List for Eko Akate 2022</h2>
                <hr>
                <div class="search">
                    ...
                    <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button title="Decline request"onclick="markAbsent('<?php echo $all->pcn_number?>')"class="action decline"><i class="fas fa-ban"></i></button>
                                    <?php
                                        }else{

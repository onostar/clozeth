            ...
            <div class="login_page">
                ...
                <form action="controller/login.php" method="POST">
                    <div class="data">
                        ...
                        <input type="email" name="email" id="email" placeholder="mail@example.com" required value="<?php if(isset($_SESSION['email'])){
                            echo $_SESSION['email'];
                    ...
                    <div class="data">
                        <div class="pass">
                            ...
                            <a href="view/forgot_password.php" title="Recover your password">Forgot password?</a>
                        </div>
